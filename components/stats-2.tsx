                ...
                <div className="@xl:grid-cols-3 mt-12 grid grid-cols-2 gap-6 text-sm">
                    <div className="border-y py-6">
                        <p className="text-muted-foreground text-xl">
                            <span className="text-foreground font-medium">40%</span> Increase in team focus velocity by automating low-level project decomposition.
                        </p>
                    </div>

                    <div className="border-y py-6">
                        <p className="text-muted-foreground text-xl">
                            <span className="text-foreground font-medium">1B+</span> Nodes of cognitive data synchronized across our global edge network every month.
                        </p>
                    </div>

                    <div className="border-y py-6">
                        <p className="text-muted-foreground text-xl">
                            <span className="text-foreground font-medium">99.9%</span> Uptime for our high-availability neural engine, keeping your flow uninterrupted.
                        </p>
                    </div>
                </div>
            </div>
