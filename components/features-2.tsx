            ...
            <div className="mx-auto max-w-2xl px-6">
                ...
                <div className="@xl:grid-cols-2 mt-12 grid gap-3 *:p-6">
                    ...
                    <Card
                        ...
                        <div className="space-y-2">
                            <h3 className="text-foreground font-medium">Cognitive Engine</h3>
                            <p className="text-muted-foreground text-sm">Autonomous task decomposition that keeps your focus synchronized across all platforms.</p>
                        </div>
                        <div
                            aria-hidden
                    ...
                    <Card
                        ...
                        className="row-span-2 grid grid-rows-subgrid overflow-hidden">
                        <div className="space-y-2">
                            <h3 className="text-foreground font-medium">Velocity First</h3>
                            <p className="text-muted-foreground mt-2 text-sm">Built for high-growth teams who prioritize shipping over micromanagement.</p>
                        </div>
                        <div
                            aria-hidden
                    ...
                    <Card
                        ...
                        className="row-span-2 grid grid-rows-subgrid">
                        <div className="space-y-2">
                            <h3 className="font-medium">Encrypted Protocol</h3>
                            <p className="text-muted-foreground text-sm">Scale confidently with end-to-end encrypted workspaces and biometric-grade security.</p>
                        </div>
